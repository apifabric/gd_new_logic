...
resourcename="gdnewlogic"  # lower case, only
resourcegroup="gdnewlogic_rg"
...
# git clone https://github.com/apilogicserver/gdnewlogic.git
# cd gdnewlogic
...
az group create --name gdnewlogic_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group gdnewlogic_rg --sku S1 --is-linux
az container create --resource-group gdnewlogic_rg --name gdnewlogic --image apilogicserver/gdnewlogic:latest --dns-name-label gdnewlogic --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//gdnewlogic.westus.azurecontainer.io:5656'
